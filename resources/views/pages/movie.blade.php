                           ...
                           <div class="film-poster col-md-9">
                              ...
                              <ul class="list-info-group">
                                 ...
                                 @endif  
                                    ...
                                    <span class="episode">@if($movie->subtitle==1)Vietsub @else Thuyết minh @endif</span></li>
                        ...
                        <article class="thumb grid-item post-38498">
                           <div class="halim-item">
                              <a class="halim-thumb" href="{{route('movie',$hot->slug)}}" title="{{$hot->title}}">
                                 ...
                                 FULL HD
                                 @endif   
                                 </span><span class="episode"><i class="fa fa-play" aria-hidden="true"></i>@if($hot->subtitle==1)Vietsub @else Thuyết minh @endif</span> 
