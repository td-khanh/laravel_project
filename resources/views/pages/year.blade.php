                                ...
                                <span>
                                    ...
                                    @for($year_bread = 2000;$year_bread<=2023;$year_bread++)
                                     <span class="breadcrumb_last" aria-current="page">
                                       <a href="{{route('nam',$year_bread)}}"> {{$year_bread}}</a> »
                                     </span>
                                     @endfor
                                    </span>
                                </span>
                     ...
                     <article class="col-md-3 col-sm-3 col-xs-6 thumb grid-item post-37606">
                        <div class="halim-item">
                           <a class="halim-thumb" href="{{route('movie',$mov->slug)}}">
                              ...
                              FULL HD
                              @endif
                              </span><span class="episode"><i class="fa fa-play" aria-hidden="true"></i>@if($mov->subtitle==1)Vietsub @else Thuyết minh @endif</span> 
