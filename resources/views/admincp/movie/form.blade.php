                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('time', isset($movie) ? $movie->time : '', ['class'=>'form-control','placeholder'=>'...']) !!}
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('resolution', ['1'=>'SD','0'=>'HD','2'=>'HD CAM','3'=>'CAM','4'=>'FULLHD'], isset($movie) ? $movie->resolution : '', ['class'=>'form-control']) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('Subtitle', 'Phụ đề', []) !!}
                            {!! Form::select('subtitle', ['1'=>'Vietsub','0'=>'Thuyết minh'], isset($movie) ? $movie->subtitle : '', ['class'=>'form-control']) !!}
                        </div>
                        {{-- <div class="form-group">
                            {!! Form::label('year', 'Năm phim', []) !!}
                            {!! Form::select('year', [], isset($movie) ? $movie->subtitle : '', ['class'=>'form-control']) !!}
                        </div> --}}
                        <div class="form-group">
