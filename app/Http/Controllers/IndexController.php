...
class IndexController extends Controller
{
    public function home(){
        $phimhot = Movie::where('phim_hot',1)->where('status',1)->orderBy('date_update','DESC')->get();
    ...
    public function movie($slug){
        ...
        $related = Movie::with('category','genre','country')->where('category_id',$movie->category->id)->orderBy(FacadesDB::raw('RAND()'))->whereNotIn('slug',[$slug])->get();
    ...
    public function year($year){
        ...
        $year = $year;
        $movie = Movie::where('year',$year)->orderBy('date_update','DESC')->paginate(40);
    ...
    public function tag($tag){
        ...
        $tag = $tag;
        $movie = Movie::where('tags','LIKE','%'.$tag.'%')->orderBy('date_update','DESC')->paginate(40);
